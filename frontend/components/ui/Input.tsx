        ...
        <div className="relative group">
          ...
          {isPassword && (
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 z-30 p-2 text-white/60 hover:text-[#1ebbf4] transition-all rounded-lg hover:bg-white/10 active:scale-95"
